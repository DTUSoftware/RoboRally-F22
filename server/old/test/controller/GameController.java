...
import dk.dtu.compute.se.pisd.roborally_server.RoboRally;
import dk.dtu.compute.se.pisd.roborally_server.model.*;
import dk.dtu.compute.se.pisd.roborally_server.model.elements.*;
...
/**
 * Controls stuff that happens on the {@link dk.dtu.compute.se.pisd.roborally_server.model.Board Board}.
 *
...
public class GameController {
     ...
     *
     * @return the random {@link dk.dtu.compute.se.pisd.roborally_server.model.CommandCard CommandCard}.
     */
    ...
    */
    ...
    /**
     * Moves a {@link dk.dtu.compute.se.pisd.roborally_server.model.CommandCard CommandCard} on a source
     * {@link dk.dtu.compute.se.pisd.roborally_server.model.CommandCardField CommandCardField} to
     * another {@link dk.dtu.compute.se.pisd.roborally_server.model.CommandCardField CommandCardField}.
     * Only moves the card, if there is a card on the source field, and there is no card on the target field.
     *
     * @param source The source {@link dk.dtu.compute.se.pisd.roborally_server.model.CommandCardField CommandCardField}.
     * @param target The {@link dk.dtu.compute.se.pisd.roborally_server.model.CommandCardField CommandCardField} to move the card to.
